    ...
    <div class="scroll-wrapper">
        <div class="menubar relative">
            <div class="page-title">
                <strong>Ijin Pulang Awal</strong>
            </div>
		...
		<div class="profile-content">
			<div class="tabs">
				<ul class="nav nav-tabs" role="tablist">
				  ...
				  <li><a href="#tab2" role="tab" data-toggle="tab">Ijin Approved</a></li>
				  <li><a href="#tab3" role="tab" data-toggle="tab">Ijin Rejected</a></li>
				</ul>
			</div> 
		</div>
        <div class="body">
					...
					<table id="datatab1" class="table table-condensed">
						...
						<tbody id="data2">
							...
							<tr>
								...
								<td align="center">{{ $value->tglijin }}</td>
								<td >{{ $value->alasan }}</td>
								<td>
