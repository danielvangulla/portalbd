		...
		<div class="profile-content">
			<div class="tabs">
				<ul class="nav nav-tabs" role="tablist">
				  <li class="active"><a href="#tab1" role="tab" data-toggle="tab">Cuti Belum Approval</a></li>
				  <li><a href="#tab2" role="tab" data-toggle="tab">Cuti Approved</a></li>
				  <li><a href="#tab3" role="tab" data-toggle="tab">Cuti Rejected</a></li>
				</ul>
			</div> 
		</div>
        <div class="body">
