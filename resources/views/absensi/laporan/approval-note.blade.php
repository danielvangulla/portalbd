    ...
    <div class="scroll-wrapper">
        <div class="menubar relative">
            <div class="page-title">
                <strong>Emergency Schedule</strong>
            </div>
		...
		<div class="profile-content">
			<div class="tabs">
				<ul class="nav nav-tabs" role="tablist">
				  <li class="active"><a href="#tab1" role="tab" data-toggle="tab">Belum Approve</a></li>
				  <li><a href="#tab2" role="tab" data-toggle="tab">Approved</a></li>
				  <li><a href="#tab3" role="tab" data-toggle="tab">Rejected</a></li>
				</ul>
			</div> 
		</div>
        <div class="body">
					...
					<table id="datatab1" class="table table-condensed">
						<thead>
							<tr>
								...
								<th tabindex="0" rowspan="1" colspan="1" style="text-align: center">Tgl Jadwal</th>
								<th tabindex="0" rowspan="1" colspan="1" style="text-align: left">Nama Karyawan</th>
								<th tabindex="0" rowspan="1" colspan="1" style="text-align: center">Jadwal Lama</th>
								<th tabindex="0" rowspan="1" colspan="1" style="text-align: center">Yang Diajukan</th>
								<th tabindex="0" rowspan="1" colspan="1" style="text-align: left;">Alasan</th>
							</tr>
						</thead>
						<tbody id="data2">
							@foreach($blmApp as $key => $v)
							<tr>
								<td align="center">{{ $v->id }}</td>
								<td align="center">{{ $v->tgl }}</td>
								<td align="left">{{ $v->karyawan->nama }}</td>
								<td align="center">
									{{ date('H:i', strtotime($v->masuk_old)) }} - {{ date('H:i', strtotime($v->pulang_old)) }}
								</td>
								<td align="center">
									{{ date('H:i', strtotime($v->masuk_new)) }} - {{ date('H:i', strtotime($v->pulang_new)) }}
								</td>
								<td >{{ $v->ket }}</td>
								<td>
