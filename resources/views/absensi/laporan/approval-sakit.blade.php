		...
		<div class="profile-content">
			<div class="tabs">
				<ul class="nav nav-tabs" role="tablist">
				  <li class="active"><a href="#tab1" role="tab" data-toggle="tab">Sakit Belum Approval</a></li>
				  <li><a href="#tab2" role="tab" data-toggle="tab">Sakit Approved</a></li>
				  <li><a href="#tab3" role="tab" data-toggle="tab">Sakit Rejected</a></li>
				</ul>
			</div> 
		</div>
        <div class="body">
					...
					<table id="datatab1" class="table table-condensed">
						<thead>
							<tr>
								...
								<th tabindex="0" rowspan="1" colspan="1" style="text-align: center">Tgl Mulai</th>
								<th tabindex="0" rowspan="1" colspan="1" style="text-align: center">Tgl Selesai</th>
								<th tabindex="0" rowspan="1" colspan="1" style="text-align: center">Jumlah</th>
						...
						<tbody id="data2">
							...
							<tr>
								...
								<td align="center">{{ $value->totalhari }} Hari</td>
