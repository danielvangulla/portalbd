    ...
    <div class="scroll-wrapper">
        <div class="menubar relative">
            <div class="page-title">
                <strong>Pengajuan Dinas Luar</strong>
            </div>
		...
		<div class="profile-content">
			<div class="tabs">
				<ul class="nav nav-tabs" role="tablist">
				  <li class="active"><a href="#tab1" role="tab" data-toggle="tab">Belum Approval</a></li>
					...
					<table id="datatab1" class="table table-condensed">
						<thead>
							<tr>
								...
								<th tabindex="0" rowspan="1" colspan="1" style="text-align: center">Tgl Dinas</th>
						...
						<tbody id="data2">
							...
							<tr>
								...
								<td align="center">{{ $value->tgldinas }}</td>
								<td >{{ $value->alasan }}</td>
								<td>
