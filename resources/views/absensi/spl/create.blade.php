...
<div class="content-wrapper">
    <div class="panel panel-default">
        ...
        <div class="panel-body">     
           ...
           @endif
            {{ Form::open(array('url' => 'spl', 'role'=>'form','class'=>'form-horizontal')) }}            
                ...
                <div class="form-group">
                    <label class="col-sm-2 col-md-2 control-label">Total Menit</label>
                    <div class="col-sm-6 col-md-4">
                ...
                <div class="form-group form-actions">
                    <div class="col-sm-offset-2 col-sm-10">                        
                        <button type="submit" class="btn btn-success">Simpan Perintah Lembur</button>
                    </div>
                </div>
