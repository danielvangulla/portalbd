...
<div class="content-wrapper">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4>Input Permohonan Ijin Pulang Awal</h4>
            <div class="row">
        ...
        <div class="panel-body">            
           ...
           @endif
            {{ Form::open(array('url' => 'ijinpulang', 'role'=>'form','class'=>'form-horizontal')) }}
                <input type="hidden" name="karyawan_id" value="{{ $karyawan->id; }}"/>
                
                <div class="form-group">
                    <label class="col-sm-2 col-md-2 control-label">Tanggal Ijin</label>
                    <div class="col-sm-5 col-md-3">
                        <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        <input id="tglijin" name="tglijin" type="text" class="form-control datepicker" />
                        </div>
                    </div> 
                </div>
