...
<div class="content-wrapper">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4>Input Pengajuan Pengecualian Scan Finger</h4>
            <div class="row">
		...
		@endif
		@if (Session::has('berhasilcreate'))
			 <div class="alert alert-success">
				 <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
				 {{ Session::get('berhasilcreate') }}
			 </div>
		@endif
            {{ Form::open(array('url' => 'exc', 'role'=>'form','class'=>'form-horizontal')) }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5 col-md-3">
                        ...
                        <input id="mulai" name="tgl" type="text" class="form-control datepicker" />
                        </div>
                    </div>
                </div>
