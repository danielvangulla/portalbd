...
<div class="content-wrapper">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4>Input Pengajuan Dinas Luar</h4>
            <div class="row">
		...
		@endif
            {{ Form::open(array('url' => 'dinas', 'role'=>'form','class'=>'form-horizontal')) }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5 col-md-3">
                        ...
                        <input id="mulai" name="tgldinas" type="text" class="form-control datepicker" />
                        </div>
                    </div>
                </div>
